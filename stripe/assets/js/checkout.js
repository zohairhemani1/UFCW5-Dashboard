            ...
            Checkout = function() {
                ...
                function Checkout(tokenCallback, host) {
                    ...
                    if (helpers.isFallback()) {
                        ...
                        path = "/v3/fallback/k2cOG4aMoRCi4ihFwg.html"
                    } else {
                        path = "/v3/JOxxtiCiYdXIToC8is2w.html";
                        if (Math.random() < .5) {
                            path = "/v3/var-7kWUNyrVt1xEYx3R74jxg.html"
                        }
                        shouldPopup = helpers.isSupportedMobileOS() && !(helpers.isNativeWebContainer() || helpers.isAndroidWebapp() || helpers.isiOSWebView() || helpers.isiOSChrome() && !helpers.isUserGesture() || helpers.isiOSBroken());
                        if (shouldPopup) {
                            viewClass = TabView
                        } else {
                ...
                Checkout.prototype.open = function(options) {
                    ...
                    return this.view.open(options, function(_this) {
                        return function(status) {
                            ...
                            _this.view = new IframeView(_this.onToken, _this.host, "/v3/JOxxtiCiYdXIToC8is2w.html");
