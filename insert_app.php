...
if($_POST)
{
	...
	$name = $_POST['name'];
	$query = "INSERT INTO app_name(name,logo,cover,time_cone)
	VALUES ('$name','$logo','$cover',now())";
...
<body>
  ...
  <div id="box">
    <form id="box1" name="form" class="form-horizontal" role="form" action="insert_app.php" method="post" enctype="multipart/form-data" onsubmit = "return validateForm()">
