               ...
               <div class="span12">
                  ...
                  <h3 class="page-title">
                   ...
                   <ul class="breadcrumb">
                       ...
                       <li><a href="#">Parent Child</a><span class="divider-last">&nbsp;</span>
                       </li>
                ...
                <div class="span12">
                    ...
                    <div class="widget">
                        <div class="widget-title">
                            ...
                            <h4><i class="icon-tags"></i>Parent Child</h4>
                            <span class="tools">
...
<div class="widget-body">
			<div class="btn-group">
               <a href="insert_parent.php"><button type="button" class="btn btn-primary"> Add New <i class="icon-plus"></i> </button></a>
                              </div>
