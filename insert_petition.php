<?php 
	...
	if(isset($_GET['member_id']))
	{
			...
			$formAction = "?member_id=$member_id";
			$select_petition = "SELECT * FROM petition_people where member_id = $member_id";
               ...
               <div class="span12">
                  ...
                  <div class="widget">
                     ...
                     <div class="widget-body form">
                        <!-- BEGIN FORM-->
                        <form action="insert_petition.php<?php echo $formAction ?>" method="post" class="form-horizontal">
                           <div class="control-group">
                              <label class="control-label">first Name</label>
                              <div class="controls">
                                 <input required placeholder="Enter Your First Name" name="first_name" 
                                 value="<?php echo $first_name; ?>" type="text" class="span6 " />
                              </div>
                           </div>
                           <div class="control-group">
                           ...
                           <div class="control-group">
                              ...
                              <div class="controls">
                                 <input required placeholder="Enter Your Email" name="email" value="<?php echo $email ?>" type="text" class="span6 " />
                              </div>
                           </div>
